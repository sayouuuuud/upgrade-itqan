...
function buildInviteEmail(opts: {
  ...
  const html = `
    <div dir="rtl" style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;
      ...
      <p style="color:#475569;line-height:1.7;">
        يدعوك <strong>${inviterName}</strong> للانضمام إلى منصة <strong>متقن التعليمية</strong>
  ...
  return {
    subject: `دعوة للانضمام إلى متقن التعليمية — ${roleLabel}`,
    html,
    body: `أهلاً، تمت دعوتك للانضمام إلى منصة متقن التعليمية. رابط الدعوة: ${inviteUrl} (صالحة حتى ${expireStr})`,
  }
}
