...
function TestimonialsMarquee() {
  ...
  const rowBottom: Testimonial[] = [
    ...
    { q: "كنتُ أبحثُ عن مَقْرأةٍ مُنضَ��طةٍ منذُ زمن، فوجدتُ هنا ما يَ��وقُ ما تَ��نَّيت.", n: "إبراهيم الرفاعي", r: "طالبٌ في الإجازة" },
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            {[
              ...
              { n: "٣", t: "احْجِزْ ��وعدَك", d: "اختر اليومَ والساعةَ من تقويمِ المُعلِّم، فيَصلُكَ تَنبيهٌ قبلَ الجلسةِ بوقتٍ كافٍ." },
        ...
        <div className="container mx-auto px-6 relative">
          <div className="grid lg:grid-cols-12 gap-10 pb-12 border-b border-[#F7F2E9]/10">
            ...
            <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                <h4 className="text-sm font-bold text-[#C9A962] mb-5 tracking-wider">الأ��اديميَّة</h4>
