...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F2E9] text-[#1A1A1A] dark:bg-[#0B1217] dark:text-[#F2EBDD] overflow-x-hidden font-sans transition-colors duration-500" dir="rtl">
      ...
      <section
        id="sections"
        className="relative py-32 md:py-40 bg-[#FAF6EE] text-[#1A1A1A] dark:bg-[#0F2A44] dark:text-[#F7F2E9] overflow-hidden border-y border-[#0F2A44]/10 dark:border-[#C9A962]/15 transition-colors duration-500"
      >
        <TessellatedBg className="absolute inset-0 w-full h-full hidden dark:block" color="#C9A962" opacity={0.04} />
        <TessellatedBg className="absolute inset-0 w-full h-full dark:hidden" color="#0F2A44" opacity={0.025} />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#F7F2E9]/30 dark:from-[#0F2A44] dark:via-[#0F2A44] dark:to-[#0a1f33]" />
