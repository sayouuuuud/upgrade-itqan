...
// Cross-origin PDFs on UploadThing/S3 can be blocked when embedded in an
// <iframe>; route them through our same-origin proxy.
const PDF_PROXY_HOST_SUFFIXES = ['utfs.io', 'ufs.sh', 'amazonaws.com', 'cloudinary.com']
